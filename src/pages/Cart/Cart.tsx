      ...
      <section className="cart">
        <div className="cart-header">
          ...
          <div className="cart-clear">
            {items.length > 0 && (
              <button onClick={handleClickClear} className="cart-clear__button">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 20 20"
        ...
        <div className="cart-footer">
          <div className="cart-footer__info">
            <p className="cart-footer__all-products">
              All products:{" "}
              <span>{items.length > 0 ? totalProducts : 0} pcs</span>
            </p>
            <p className="cart-footer__all-price">
              Your order price: <span>${totalPrice.toFixed(2)}</span>
            </p>
          </div>
